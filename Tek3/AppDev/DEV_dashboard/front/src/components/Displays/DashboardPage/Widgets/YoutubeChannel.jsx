...
const WidgetYoutubeChannel = ({index, list, setList}) => {
    ...
    useEffect(() => {
        const myInit = {
            ...
            mode: "cors",
            cache: "default",
            body: JSON.stringify({request: "https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2CcontentDetails%2Cstatistics&id=" + list[index].channel + "&key=XXXXXXXX_GOOGLE_API_KEY_REDACTED_XXXXXXXX&access-token=XXXXXXXX_GOOGLE_OAUTH_ID_TOKEN_REDACTED_XXXXXXXX"})
        };
...
/**
 * https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2CcontentDetails%2Cstatistics&id=UC2Kl-Y9g3CJST4U8kAyYxHw&key=XXXXXXXX_GOOGLE_API_KEY_REDACTED_XXXXXXXX&access-token=XXXXXXXX_GOOGLE_OAUTH_ID_TOKEN_REDACTED_XXXXXXXX
 */