...
Test(check_echec_exec, check_echec_exec)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 30, 123), 0);
}
...
Test(check_echec_exec, check_echec_exec2)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 3120, 123), 0);
}
...
Test(check_echec_exec, check_echec_exec_one)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 1, 1), 0);
}
...
Test(check_echec_exec, check_echec_exec_two)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 13, 13), 0);
}
...
Test(check_echec_exec, check_echec_exec_three)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 30, 30), 0);
}
...
Test(check_echec_exec, check_echec_exec_four)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 37, 37), 0);
}
...
Test(check_echec_exec, check_echec_exec_five)
{
    ...
    var->arg = arg;
    var->quit = 1;
    cr_expect_eq(check_echec_exec(var, 47, 47), 0);
}