...
int chose_good_operator(variable_t *var, tree_t *tree)
{
    switch (tree->operator) {
        case 0: return (control_semicolon(var, tree));
        case 1: return (control_pipe(var, tree));
        case 2: return (control_double_left_chevron(var, tree));
        case 3: return (control_left_chevron(var, tree));
        case 4: return (control_double_right_chevron(var, tree));
        case 5: return (control_right_chevron(var, tree));
        default : return (84);
    }
    return (84);
}
