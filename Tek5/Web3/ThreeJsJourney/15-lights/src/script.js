...
directLight.position.z = 4
scene.add(directLight)

const hemisphere = new THREE.HemisphereLight(0xff0000, 0x0000ff, 0.5)
scene.add(hemisphere)

// const pointLight = new THREE.PointLight(0xff00ff, 0.5, 9)
// pointLight.position.x = -2
// pointLight.position.y = 3
// pointLight.position.z = -4
// scene.add(pointLight)

//? MeshStanrdMaterial & MeshPhysicalMaterial Uniquement
// const areLight = new THREE.RectAreaLight(0x4e00ff, 1, 5, 1)
// areLight.lookAt(new THREE.Vector3())
// scene.add(areLight)
...
//? Performance des light => Backing est une solution
/*
Minimal cost:
    AmbientLight
    HemisphereLight
...
// const rectAreaLightHelper = new RectAreaLightHelper(areLight)
